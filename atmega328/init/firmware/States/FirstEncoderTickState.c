...
void FirstEncoderTickState::spin(void) {
	...
	while(1) { // abs(Encoder::position) < 18
		if(sine_idx == 127) {
			...
			PORTC = (PORTC & 0b11100111) | (this->phase << 3) | (!this->phase << 4);
		}
